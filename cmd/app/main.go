...
func main() {
	...
	b.RegisterHandler(bot.HandlerTypeCallbackQueryData, handler.CallbackAdminTools, bot.MatchTypeExact, h.AdminToolsCallbackHandler, isAdminMiddleware)
	b.RegisterHandler(bot.HandlerTypeCallbackQueryData, handler.CallbackAdminToolsResetDiamonds, bot.MatchTypeExact, h.AdminToolsResetDiamondsCallbackHandler, isAdminMiddleware)
